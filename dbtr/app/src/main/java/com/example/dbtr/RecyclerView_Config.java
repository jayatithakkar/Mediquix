...
public class RecyclerView_Config {
    ...
    public void setConfig(RecyclerView rv, Context cn, List<Book> bk, List<String> s){
        mContext=cn;
    ...
    class BookItemView extends RecyclerView.ViewHolder {
        ...
        public BookItemView(ViewGroup parent){
            ...
            mCaategory=(TextView) itemView.findViewById(R.id.category_txtView);
        }
        public void bind(Book book, String key){
            mTitle.setText(book.getTitle());
            mAuthor.setText(book.getAuthor());
            mISBN.setText(book.getIsbn());
            mCaategory.setText(book.getCategory_name());
            this.key=key;
        }
    }
